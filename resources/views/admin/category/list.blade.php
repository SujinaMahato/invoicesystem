...
<body class="bg-gray-100">
    ...
    <div class="container px-4 py-8 mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Manage Category</h2>
            ...
            <table class="min-w-full bg-white border rounded-lg">
                ...
                <thead class="text-white bg-purple-500 ">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-sm font-semibold text-left">Category Name</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">{{ ucfirst($category->status) }}</td>
                        <td class="px-6 py-4 text-sm">
                            <!-- Action Buttons -->
                            <a href="{{ route('category.edit', $category->id) }}" class="inline-block px-2 py-1 text-white transition bg-blue-500 rounded hover:bg-blue-600">
