    ...
    <div class="p-4 bg-white shadow">
        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $category->name) }}" class="block w-full p-2 mt-1 border border-gray-300 rounded-lg" required>
                @error('name')
            ...
            <div class="flex items-center justify-between">
                <a href="{{url('/list')}}" class="text-purple-500 hover:text-blue-700">Back to List</a>
