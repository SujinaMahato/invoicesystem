...
@section('content')
    ...
    <div class="p-4 bg-white rounded-lg shadow-lg">
        ...
        <div class="overflow-x-auto">
            <table id="stockTable" class="min-w-full bg-white border border-gray-200">
                            ...
                            <td class="flex px-4 py-2 space-x-2">
                                ...
                                <form action="{{ route('manage.delete', $saleterm->id) }}" method="POST" class="inline">
                                    ...
                                    <button type="submit" class="flex items-center px-2 py-1 space-x-1 text-white bg-red-400 rounded-md hover:bg-red-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm2 2a1 1 0 011 1v8a1 1 0 01-2 0V5a1 1 0 011-1zm4 1a1 1 112 0v8a1 1 112 0V5z" clip-rule="evenodd" />
                                        </svg>
                                        <span>Delete</span>
                                    </button>
                                </form>
